...
create table security_question(
	question_id int(8) primary key not null,
    question varchar(1000) not null
);

insert into security_question (question_id, question) values (0, '--Cau hoi bao mat--');
...
alter table account add constraint account_questionid_fk1 foreign key (question_id) references security_question(question_id);